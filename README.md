...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-sa9tnrc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-sa9tnrc.containers.anotherwebservice.com/
...
```
git clone git@github.com:CorentissDelirium/container-sa9tnrc.git
cd container-sa9tnrc
```
...
```
docker attach container-sa9tnrc
```
